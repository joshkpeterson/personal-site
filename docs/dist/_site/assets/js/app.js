  ...
  return {
    ...
    initGradient: function() {
      ...
      var color2 = "rgb("+r2+","+g2+","+b2+")";
       ...
       document.getElementById('gradient')style.css = 
         "background: -webkit-gradient(linear, left top, right top, from("+color1+"), to("+color2+")), background: -moz-linear-gradient(left, "+color1+" 0%, "+color2+" 100%)";
        step += gradientSpeed;
        if ( step >= 1 )
        {
          step %= 1;
